                                            ...
                                            <tr>
                                                <td width="560" class="esd-container-frame" align="center" valign="top">
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size: 0px;"><a target="_blank"><img src="https://fcscylv.stripocdn.email/content/guids/CABINET_86c90c5589518aee732fd2a08463175474396bc3a2ff2392a2aea75040b79126/images/logo_1.png" alt style="display:block" width="100" class="adapt-img"></a></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <tr>
                                                <td width="560" class="esd-container-frame" align="center" valign="top">
                                                    <table cellpadding="0" cellspacing="0" width="100%" style="border-radius: 5px; border-collapse: separate;">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" class="esd-block-button es-p10t es-p10b"><span class="es-button-border" style="border-radius:6px;background:#f1c232"><a href class="es-button" target="_blank" style="padding-left:30px;padding-right:30px;border-radius:6px;background:#f1c232;mso-border-alt:10px solid #f1c232">SHOP NOW</a></span></td>
                                                        </tr>
                                                        <tr>
