...
@section('tittle', 'Topper')
@section('content')
    <div class="row mb-9 align-items-center">
        <div class="col-xxl-9">
            <div class="row">
                <div class="col-sm-6 mb-8 mb-sm-0">
                    <h2 class="fs-4 mb-0">Topper</h2>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <form  method="post" id="topper" >
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary">Create Topper</button>
                        </div>
                    </form>
                </div>
                <div class="col-md-9">
                            ...
                            <script>
                                $(document).ready(function () {
                                    $('.delete-user-btn').click(function () {
                                        ...
                                        Swal.fire({
                                            title: 'Are you sure?',
                                            text: 'Do you want to delete this topper',
                                            icon: 'warning',
                                            ...
                                            if (result.isConfirmed) {
                                                ...
                                                $('#loadingSpinner').show();
                                                $.ajax({
                                                    url: '{{ url('admin/deletetopper') }}/' + selectedValue,
                                                    type: 'GET',
            ...
            <form id="dataForm" >
                ...
                <div class="card card-body">
                    <div class="card"style="border-radius: 30px; background-color: #ffffff; box-shadow: 0px 0px 20px rgba(0, 0, 0, 0.3);">
                        <p class="text-center" >EDIT TOPPER</p>
                    </div>
