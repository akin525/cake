...
@section('tittle', 'Attribute')
@section('content')
    <div class="row mb-9 align-items-center">
        <div class="col-xxl-9">
            <div class="row">
                <div class="col-sm-6 mb-8 mb-sm-0">
                    <h2 class="fs-4 mb-0">Attribute</h2>
                </div>
...
{{--                        <div class="mb-8">--}}
{{--                            <label for="product_slug" class="mb-5 fs-13px ls-1 fw-semibold text-uppercase">Color</label>--}}
{{--                            <input type="color" name="name" placeholder="Type here" class="form-control" id="name">--}}
{{--                        </div>--}}
{{--                        <div class="mb-8">--}}
                                ...
                                <div class="modal-content">
                                    <form id="dataForm" >
                                        ...
                                        <div class="card card-body">
                                            ...
                                            <p class="text-center" >Edit Attribute</p>
                                            </div>
