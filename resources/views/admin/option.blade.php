            ...
            <div class="row">
                <div class="col-md-3">
                    <form id="cat">
                        @csrf
                        <div class="mb-8">
                            <label for="product_name" class="mb-5 fs-13px ls-1 fw-semibold text-uppercase">Product</label>
                            <input type="text" name="product" placeholder="Type here" class="form-control" id="product_name">
                        </div>
                        <div class="mb-8">
                            <label for="product_slug" class="mb-5 fs-13px ls-1 fw-semibold text-uppercase">Price</label>
                            <input type="number" name="price" placeholder="Type here" class="form-control" id="product_slug">
                        </div>
{{--                        <div class="mb-8">--}}
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle table-nowrap mb-0 table-borderless"><thead class="table-light">
                                ...
                                <tr>
                                    ...
                                    <td class="text-body-emphasis">{{$cat['product']}}</td>
                                    <td class="text-body-emphasis">₦{{number_format(intval($cat['price'] *1),2)}}</td>
                                    <td class="text-center">
