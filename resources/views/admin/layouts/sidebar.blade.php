...
<head>
    ...
    <link rel="stylesheet" href="{{asset('cdn.jsdelivr.net/npm/select2%404.0.13/dist/css/select2.min.css')}}" />
                    ...
                    <div class="collapse navbar-collapse bg-body position-relative z-index-5" id="primaryMenuSidebar">
                        ...
                        <ul class="list-group list-group-flush list-group-no-border w-100 p-6">
                            <li class="list-group-item px-0 py-0 sidebar-item mb-3 border-0">
                                <a href="{{route('admin/dashboard')}}" class="text-heading text-decoration-none lh-1 sidebar-link py-5 px-6 d-flex align-items-center" title="Dashboard">
...
<i class="fas fa-home-lg-alt"></i>
                            ...
                            <li class="list-group-item px-0 py-0 sidebar-item mb-3 border-0">
                                <a href="{{route('admin/attribute')}}" class="text-heading text-decoration-none lh-1 sidebar-link py-5 px-6 d-flex align-items-center" title="Dashboard">
<span class="sidebar-item-icon w-40px d-inline-block text-muted">
<i class="fas fa-home-lg-alt"></i>
</span>
...
<i class="fas fa-question alt"></i>
                                    ...
                                    <span class="sidebar-item-text fs-14px fw-semibold">FAQ</span>
                                </a>
                            </li>
                            <li class="list-group-item px-0 py-0 sidebar-item mb-3 border-0">
                                <a href="{{route('admin/gateway')}}" class="text-heading text-decoration-none lh-1 sidebar-link py-5 px-6 d-flex align-items-center" title="Dashboard">
<span class="sidebar-item-icon w-40px d-inline-block text-muted">
                        ...
                        <div class="col-md-6 d-flex flex-wrap justify-content-md-end align-items-center order-0 order-md-1">
                            ...
                            <div class="dropdown pl-2 py-2">
                                <a href="#" class="dropdown-toggle text-heading pr-3 pr-sm-6 d-flex align-items-center justify-content-end" data-bs-toggle="dropdown">
                                    <img src="{{asset('admin/assets/images/dashboard/avatar-2.png')}}" alt="Ronald Hunter" class="rounded-circle" width="40">
                                </a>
...
<script src="{{asset('admin/assets/vendors/bootstrap/js/bootstrap.bundle.js')}}"></script>
<script src="{{asset('admin/assets/vendors/clipboard/clipboard.min.js')}}"></script>
<script src="{{asset('admin/assets/vendors/vanilla-lazyload/lazyload.min.js')}}"></script>
<script src="{{asset('admin/assets/vendors/waypoints/jquery.waypoints.min.js')}}"></script>
<script src="{{asset('admin/assets/vendors/lightgallery/lightgallery.min.js')}}"></script>
<script src="{{asset('admin/assets/vendors/lightgallery/plugins/zoom/lg-zoom.min.js')}}"></script>
<script src="{{asset('admin/assets/vendors/lightgallery/plugins/thumbnail/lg-thumbnail.min.js')}}"></script>
<script src="{{asset('admin/assets/vendors/lightgallery/plugins/video/lg-video.min.js')}}"></script>
<script src="{{asset('admin/assets/vendors/lightgallery/plugins/vimeoThumbnail/lg-vimeo-thumbnail.min.js')}}"></script>
<script src="{{asset('admin/assets/vendors/isotope/isotope.pkgd.min.js')}}"></script>
<script src="{{asset('admin/assets/vendors/slick/slick.min.j')}}s"></script>
<script src="{{asset('admin/assets/vendors/gsap/gsap.min.js')}}"></script>
<script src="{{asset('admin/assets/vendors/gsap/ScrollToPlugin.min.js')}}"></script>
