                        ...
                        @forelse($product as $pro)
                            <div class="col mb-50">
                                ...
                                <div class="product-item text-center" style="border-radius: 50px; background-color: #ffffff; box-shadow: 0px 0px 20px rgba(0, 0, 0, 0.3);">
                                    <div class="product-item__badge" style="background-color: #EF9B00; color: black">Hot</div>
                                    ...
                                    <div class="product-item__content pt-5">
                                        <h5 class="product-item__title" style="font-size: 14px"><a href="{{route('cakedetail', $pro['id'])}}">{{$pro['name']}}</a></h5>
                                        @if($pro['ramount'] != null)
                                            <span class="product-item__price " style="font-size: 14px">₦{{number_format(intval($pro['ramount'] *1))}}</span>-
                                            <span class="product-item__price " style="font-size: 14px">₦{{number_format(intval($pro['tamount'] *1))}}</span>
                                        @else
                                            <span class="product-item__price " style="font-size: 14px">₦{{number_format(intval($pro['price'] *1))}}</span>
                                        @endif
                                    </div>
                                </div>
                                <!-- Product Item End -->
